...
#define _nstates1	3	/* :init: */
#define minseq1	14
#define maxseq1	15
#define _endstate1	2

#define _nstates0	15	/* testcount */
#define minseq0	0
#define maxseq0	13
...
#define Ptestcount	((P0 *)_this)
typedef struct P0 { /* testcount */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 5; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, x) - 1*sizeof(uchar))
